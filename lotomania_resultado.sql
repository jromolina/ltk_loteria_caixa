...
create table lotomania.lotomania_resultado_grupo_com_4(
  ...
  grp_2                    NUMERIC DEFAULT 0 check (grp_2 in (0, 4)),
  grp_3                    NUMERIC DEFAULT 0 check (grp_3 in (0, 4)),
  grp_4                    NUMERIC DEFAULT 0 check (grp_4 in (0, 4)),
  grp_5                    NUMERIC DEFAULT 0 check (grp_5 in (0, 4)),
  grp_6                    NUMERIC DEFAULT 0 check (grp_6 in (0, 4)),
  grp_7                    NUMERIC DEFAULT 0 check (grp_7 in (0, 4)),
  grp_8                    NUMERIC DEFAULT 0 check (grp_8 in (0, 4)),
  grp_9                    NUMERIC DEFAULT 0 check (grp_9 in (0, 4)),
  grp_10                   NUMERIC DEFAULT 0 check (grp_10 in (0, 4)),
  grp_11                   NUMERIC DEFAULT 0 check (grp_11 in (0, 4)),
  grp_12                   NUMERIC DEFAULT 0 check (grp_12 in (0, 4)),
  grp_13                   NUMERIC DEFAULT 0 check (grp_13 in (0, 4)),
  grp_14                   NUMERIC DEFAULT 0 check (grp_14 in (0, 4)),
  grp_15                   NUMERIC DEFAULT 0 check (grp_15 in (0, 4)),
  grp_16                   NUMERIC DEFAULT 0 check (grp_16 in (0, 4)),
  grp_17                   NUMERIC DEFAULT 0 check (grp_17 in (0, 4)),
  grp_18                   NUMERIC DEFAULT 0 check (grp_18 in (0, 4)),
  grp_19                   NUMERIC DEFAULT 0 check (grp_19 in (0, 4)),
  grp_20                   NUMERIC DEFAULT 0 check (grp_20 in (0, 4)),
  grp_21                   NUMERIC DEFAULT 0 check (grp_21 in (0, 4)),
  grp_22                   NUMERIC DEFAULT 0 check (grp_22 in (0, 4)),
  grp_23                   NUMERIC DEFAULT 0 check (grp_23 in (0, 4)),
  grp_24                   NUMERIC DEFAULT 0 check (grp_24 in (0, 4)),
  grp_25                   NUMERIC DEFAULT 0 check (grp_25 in (0, 4)),
